...
\newcommand{\typesFig}{
	\begin{figure}
		...
		\caption{The three types of bivariate visualizations explored in this work: scatterplots, linegraphs, and area charts. The density of points made bar charts and area charts visually similar, and so we excluded bar charts from our experiments. Likewise, the error in estimating trends from heatmaps~\protect\cite{fuchs2013evaluation} made them unsuitable for the experimental task.}
		\label{fig:types}
	\end{figure}
}
